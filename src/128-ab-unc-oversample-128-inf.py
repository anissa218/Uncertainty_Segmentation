...
def create_args(user='anissa', experiment='ab-unc-oversample-128-epoch198-2', date=None, description='Trustworthy medical image segmentation by coco, training on trai_imgsn.txt!',
                ...
                test_date='2023-01-01', test_epoch=199, n_skip=3, vit_name='R50-ViT-B_16', vit_patches_size=16,train_file = 'pos_train_imgs.txt',val_file = 'pos_val_imgs.txt',test_file = 'test_imgs.txt',Uncertainty_Loss=False,save_dir='./results'):
...
for i, data in enumerate(test_loader):
    ...
    with torch.no_grad():
        ...
        if args.dataset=='autopet' or args.dataset=='autopet2':
            ...
            output_dir = 'test_output_2_' + str(model_name)
