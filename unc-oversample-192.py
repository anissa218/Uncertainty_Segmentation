...
def create_args(user='anissa', experiment='unc-oversample-192-epoch344', date=None, description='Trustworthy medical image segmentation by coco, training on trai_imgsn.txt!',
