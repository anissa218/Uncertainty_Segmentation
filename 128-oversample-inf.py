...
def create_args(user='anissa', experiment='U128_oversamplingtraintest_epoch170', date=None, description='Trustworthy medical image segmentation by coco, training on trai_imgsn.txt!',
                mode='train', dataset='autopet', crop_H=128, crop_W=128, crop_D=128, num_classes=2,
                input_modality='petct', folder='folder0', input_C=2, input_H=128, input_W=128, input_D=128,
                output_D=128, lr=0.0002, weight_decay=1e-5, submission='./results', seed=1000, no_cuda=False,
                ...
                test_date='2023-01-01', test_epoch=199, n_skip=3, vit_name='R50-ViT-B_16', vit_patches_size=16,train_file = 'train_imgs.txt',val_file = 'val_imgs.txt',test_file = 'test_imgs.txt',Uncertainty_Loss=False,save_dir='./results'):
...
#model_name ='U_autopet_folder0_DUloss_epoch_199.pth'
#model_name = 'U_overssample_128_U_autopet_folder0_epoch_65.pth'
